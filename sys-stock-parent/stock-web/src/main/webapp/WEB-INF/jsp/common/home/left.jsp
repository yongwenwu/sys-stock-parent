...
<div class="default-main-layout indexleft">
		<ul class="navigationleft">
			...
			<li>
				<p>
					<a href="javascript:void(0)"><i class="pic_dnzt_hui"></i>仓库信息管理<span class="updown"></span></a>
				</p>
				<ol class="nextol">
					<li><a href="javascript:void(0)">入库管理</a></li>
					<li><a href="javascript:void(0)">出库管理</a></li>
				</ol>
			</li>
			<li>
				<p>
				...
				<ol class="nextol">
					...
					<li><a href="javascript:void(0)">库存查询</a></li>
					<li><a href="javascript:void(0)">库存进出明细</a></li>
				</ol>
			</li>
			<li>
				<p>
			...
			<li>
				...
				<ol class="nextol">
					...
					<li><a href="javascript:void(0)">商品查询</a></li>
			...
			<li>
				...
				<ol class="nextol">
					...
					<li><a href="javascript:void(0)">用户权限管理</a></li>
				</ol>
			</li>
		</ul>
	</div>